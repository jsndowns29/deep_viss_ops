...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeepVissOps.Image();
  });
  ...
  describe('Image', function() {
    it('should create an instance of Image', function() {
      ...
      //var instane = new DeepVissOps.Image();
      //expect(instance).to.be.a(DeepVissOps.Image);
    });
    ...
    it('should have the property imageContentType (base name: "imageContentType")', function() {
