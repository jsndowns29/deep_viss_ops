...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeepVissOps.Event();
  });
  ...
  describe('Event', function() {
    it('should create an instance of Event', function() {
      ...
      //var instane = new DeepVissOps.Event();
      //expect(instance).to.be.a(DeepVissOps.Event);
    });
    ...
    it('should have the property featuresMap (base name: "featuresMap")', function() {
      // uncomment below and update the code to test the property featuresMap
      //var instane = new DeepVissOps.Event();
      //expect(instance).to.be();
    });

    it('should have the property processedImage (base name: "processedImage")', function() {
      // uncomment below and update the code to test the property processedImage
      //var instane = new DeepVissOps.Event();
      //expect(instance).to.be();
    });
