...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeepVissOps.GeoPosition();
  });
  ...
  describe('GeoPosition', function() {
    it('should create an instance of GeoPosition', function() {
      // uncomment below and update the code to test GeoPosition
      //var instane = new DeepVissOps.GeoPosition();
      //expect(instance).to.be.a(DeepVissOps.GeoPosition);
    });
